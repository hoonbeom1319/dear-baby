                    ...
                    <table className="w-full table-auto">
                        <thead className="text-left text-xs font-bold text-neutral-600">
                            <tr>
                                ...
                                <th className="px-6 py-3">시·도 코드</th>
                                <th className="px-6 py-3">시·군·구 코드</th>
                                <th className="px-6 py-3">시설 수</th>
                        ...
                        <tbody className="text-sm text-neutral-800">
                            {items.length === 0 ? (
                                <tr>
                                    <td className="px-6 py-10 text-neutral-500" colSpan={6}>
                                ...
                                items.map((p) => (
                                    <tr key={p.id} className="border-t border-neutral-100">
                                        ...
                                        <td className="px-6 py-4">{p.subRegionCode}</td>
                                        <td className="px-6 py-4">{p.amenityCodes.length}</td>
