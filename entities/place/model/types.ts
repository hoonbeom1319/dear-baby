...
/** 핀만 옮기면 source='manual', 카카오 검색으로 장소를 바꾸면 source='kakao'+kakaoPlaceId. */
export type PlacePatch = { name?: string; lat?: number; lng?: number; source?: PlaceSource; kakaoPlaceId?: string | null };
